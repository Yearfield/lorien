...
void main() {
  test('≤7 words passes; 8 fails', () {
    expect(
        maxSevenWordsAndAllowed('one two three four five six seven',
            field: 'T'),
        isNull);
    expect(
        maxSevenWordsAndAllowed('one two three four five six seven eight',
            field: 'T'),
        isNotNull);
  });
  ...
  test('Special characters allowed', () {
    ...
    expect(
        maxSevenWordsAndAllowed('Heart rate - elevated', field: 'T'), isNull);
  });
}
