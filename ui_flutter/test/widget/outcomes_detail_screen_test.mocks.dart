...
// in lorien/test/widget/outcomes_detail_screen_test.dart.
...
import 'package:lorien/data/triage_repository.dart' as _i11;
import 'package:lorien/models/triage_models.dart' as _i8;
...
class _FakeTriageDetail_6 extends _i1.SmartFake implements _i8.TriageDetail {
  _FakeTriageDetail_6(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
/// A class which mocks [TriageRepository].
///
/// See the documentation for Mockito's code generation for more information.
class MockTriageRepository extends _i1.Mock implements _i11.TriageRepository {
  ...
  @override
  _i9.Future<(List<_i8.TriageLeaf>, int)> searchLeaves({
    String? query,
    bool? leafOnly = true,
    String? vm,
    String? sort,
    int? limit,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i9.Future<(List<_i8.TriageLeaf>, int)>.value(
            (<_i8.TriageLeaf>[], 0)),
      ) as _i9.Future<(List<_i8.TriageLeaf>, int)>);

  @override
  _i9.Future<_i8.TriageDetail> getLeaf(int? nodeId) => (super.noSuchMethod(
        Invocation.method(
          #getLeaf,
          [nodeId],
        ),
        returnValue: _i9.Future<_i8.TriageDetail>.value(_FakeTriageDetail_6(
          this,
          Invocation.method(
            #getLeaf,
            [nodeId],
      ...
      ) as _i9.Future<_i8.TriageDetail>);

  @override
  _i9.Future<bool> saveLeaf(
    int? nodeId,
    String? triage,
    String? actions,
  ) =>
  ...
  @override
  _i9.Future<bool> llmEnabled() => (super.noSuchMethod(
        Invocation.method(
          #llmEnabled,
          [],
        ),
  ...
  @override
  _i9.Future<(String, String)> llmFill(_i8.LlmFillRequest? request) =>
      (super.noSuchMethod(
        Invocation.method(
          #llmFill,
          [request],
  ...
  @override
  _i9.Future<(String, String)?> copyFromLastVm(String? vm) =>
      (super.noSuchMethod(
        Invocation.method(
          #copyFromLastVm,
          [vm],
