...
class DatabaseMonitor:
    ...
    async def check_database_health(self, conn: sqlite3.Connection) -> DatabaseHealth:
        ...
        try:
            ...
            cursor = await to_thread.run_sync(conn.execute, 
            ...
            if not integrity_ok:
                ...
                status = "degraded"
            elif len([a for a in self._alerts if a.level in [AlertLevel.ERROR, AlertLevel.CRITICAL]]) > 5:
                status = "degraded"
    ...
    def get_optimization_recommendations(self) -> List[str]:
        ...
        slow_queries = [m for m in self._query_metrics.values() 
        ...
        select_queries = [m for m in self._query_metrics.values() 
