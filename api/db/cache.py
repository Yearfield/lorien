...
class QueryCache:
    ...
    def __init__(
        ...
        logger.info(f"Query cache initialized: max_size={max_size_bytes/1024/1024:.1f}MB, "
            ...
            async with self._stats_lock:
                ...
                if total_requests > 0:
                    self._stats.avg_access_time_ms = (
                        (self._stats.avg_access_time_ms * (total_requests - 1) + access_time) / total_requests
                    )
