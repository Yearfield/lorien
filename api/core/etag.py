...
class ETagManager:
    ...
    @staticmethod
    def generate_etag(data: dict[str, Any] | str | int | float) -> str:
        """
    ...
    @staticmethod
    def generate_version_etag(version: int, timestamp: str | None = None) -> str:
        """
    ...
    def generate_node_etag(node_id: int, version: int, updated_at: str) -> str:
        ...
        Returns:
            ETag string
        """
        data = {"node_id": node_id, "version": version, "updated_at": updated_at}
        return ETagManager.generate_etag(data)
    ...
    @staticmethod
    def validate_etag(etag: str, expected_data: dict[str, Any] | str | int | float) -> bool:
        """
    ...
    @staticmethod
    def parse_if_match_header(if_match: str | None) -> str | None:
        """
    ...
    @staticmethod
    def check_etag_match(if_match: str | None, current_etag: str) -> bool:
        """
    ...
    def create_etag_response_headers(etag: str) -> dict[str, str]:
        ...
        Returns:
            Headers dictionary
        """
        return {"ETag": etag, "Cache-Control": "no-cache, must-revalidate"}

    @staticmethod
    def create_etag_error_response(if_match: str | None, current_etag: str) -> dict[str, Any]:
        """
...
class ConcurrencyError(Exception):
    ...
    def __init__(
        self, message: str, expected_etag: str | None = None, current_etag: str | None = None
    ):
...
def require_etag_match(if_match: str | None, current_etag: str) -> None:
    """
